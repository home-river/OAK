...
- 字段：
  ...
  - 深度：enable_depth, depth_resolution, depth_min_threshold, depth_max_threshold, align_depth_to_rgb, median_filter(3/5/7), left_right_check, extended_disparity, subpixel
