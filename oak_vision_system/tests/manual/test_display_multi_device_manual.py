...
def test_scenario_1(event_bus: EventBus, display_manager: DisplayManager):
    """场景1：只有一个设备在线
...
def test_scenario_2(event_bus: EventBus, display_manager: DisplayManager):
    """场景2：两个设备都在线
...
def test_scenario_3(event_bus: EventBus, display_manager: DisplayManager):
    """场景3：设备动态上线/下线
